...
(function () {
    ...
    function initialize() {
        ...
        setPlaceholderImage();
        document.getElementById("__xmlview0--pictureBtn").addEventListener("click", capturePhoto);

        locate();
        //document.getElementById("__xmlview0--btnLocate").addEventListener("click", locate);
        ...
        //document.getElementById("__xmlview0--btnShare").addEventListener("click", App.share);
    ...
    function updatePosition() {
        ...
        var locationOutput = document.getElementById("__xmlview0--txtLocation");
        ...
        WinJS.xhr({
            ...
            var map = new Microsoft.Maps.Map(document.getElementById("__xmlview0--mapDiv"),
                          {
    ...
    function search_createMapPin(result, map) {
        if (result) {
            var pin = new Microsoft.Maps.Pushpin(result.location, null);
            Microsoft.Maps.Events.addHandler(pin, 'click', function () {
                search_showInfoBox(result, map)
            });
            map.entities.push(pin);
        }
    }

    function search_showInfoBox(result, map) {
        if (currInfobox) {
    ...
    function capturePhoto() {
        var photoDiv = document.getElementById("__xmlview0--photo");
    ...
    function setPlaceholderImage() {
        ...
        var photo = document.getElementById("__xmlview0--photo");
        ...
        var fontSize = document.getElementById("__xmlview0--photoSection").querySelector("h3").clientHeight;
    ...
    function scalePhoto() {
        ...
        var photoImg = document.getElementById("__xmlview0--photoImg");
        ...
        if (App.lastCapture != null) {
            scaleImageToFit(photoImg, document.getElementById("__xmlview0--photo"), App.lastCapture);
        } else {
            setPlaceholderImage();
        }
    }
    ...
    function photoHeight() {
        ...
        if (photo.clientHeight == 0) {
            return photo.parentElement.clientHeight - document.getElementById("__xmlview0--photoHeading").clientHeight - 16;
        } else {
